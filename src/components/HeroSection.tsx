      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28 text-center">
        ...
        <div className="max-w-xl mx-auto mb-16">
          <div className="relative">
            ...
            />
            <button className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-orange-500 hover:bg-orange-600 rounded-full flex items-center justify-center transition-colors shadow-lg">
