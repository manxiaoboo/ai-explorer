...
export async function generateMetadata({ params }: CategoryPageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: category.metaDescription || `Discover the best ${category.name.toLowerCase()} AI tools. Compare features, pricing, and find the perfect solution for your needs.`,
    alternates: {
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <header className="mb-8">
          ...
          <p className="text-sm text-gray-500 mt-4">{category.tools.length} tools found</p>
        </header>
